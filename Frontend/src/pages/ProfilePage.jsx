        ...
        <div className='bg-base-300 rounded-xl p-6 space-y-8'>
          ...
          <div className='flex flex-col items-center gap-4'>
            <div className='relative'>
              ...
              <label htmlFor="avatar-upload" className={`absolute bottom-0 right-0 bg-base-content hover:scale-105 p-2 rounded-full cursor-pointer transform-all duration-200 ${isUpdatingProfile ? "animate-pulse pointer-events-none": ""}`}>
