          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                ...
                <input type="email" className={`input input-bordered w-full pl-10`} placeholder='you@example.com' autoComplete="username" value={formData.email} onChange={(e)=>setformData({...formData, email:e.target.value})}
                />
              </div>
            </div>
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                ...
                <input type={showPassword ? "text" : "password"} className={`input input-bordered w-full pl-10`} placeholder='● ● ● ● ●' value={formData.password} autoComplete="current-password" onChange={(e)=>setformData({...formData, password:e.target.value})}
                />
                <button type='button' className='absolute inset-y-0 right-0 pr-3 flex items-center' onClick={()=>setshowPassword(!showPassword)}>
                  {showPassword ? (
                    <EyeOff className='size-5 text-base-content/40 z-10'/>) : (<Eye className='size-5 text-base-content/40 z-10'/>)
                  }
                </button>
              </div>
            </div>
